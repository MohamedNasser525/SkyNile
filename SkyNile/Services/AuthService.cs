...
namespace SkyNile.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(ApplicationDbContext context,UserManager<User> userManager, RoleManager<IdentityRole> roleManager, IOptions<JWT> jwt)
        {
        ...
        public async Task<AuthModel> RegisterAsync(Register model)
        {
            ...
            var user = new User
            {
                ...
                FlightPreference = model.FlightPreference
            };
