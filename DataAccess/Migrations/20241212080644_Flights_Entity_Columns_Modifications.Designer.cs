...
namespace DataAccess.Migrations
{
    ...
    [Migration("20241212080644_Flights_Entity_Columns_Modifications")]
    partial class Flights_Entity_Columns_Modifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessLogic.Models.Airplane", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BusinessLogic.Models.Flight", b =>
                {
                    ...
                    b.HasIndex("ArrivalCountry");

                    b.HasIndex("ArrivalTime");

                    b.HasIndex("DepartureAirport");

                    b.HasIndex("DepartureCountry");
            ...
            modelBuilder.Entity("BusinessLogic.Models.Offer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BusinessLogic.Models.User", b =>
                {
                    ...
                    b.Property<string>("FlightPreference")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
            ...
            modelBuilder.Entity("BusinessLogic.Models.Flight", b =>
                {
                    b.HasOne("BusinessLogic.Models.Airplane", "Airplane")
                        .WithMany("Flights")
            ...
            modelBuilder.Entity("BusinessLogic.Models.Offer", b =>
                {
                    b.HasOne("BusinessLogic.Models.Ticket", "Ticket")
                        .WithMany()
            ...
            modelBuilder.Entity("BusinessLogic.Models.Ticket", b =>
                {
                    b.HasOne("BusinessLogic.Models.Flight", "Flight")
                        .WithMany("Tickets")
